...
import { addNewProductValidation, initialValuesProduct } from '~/utils'

type Props = {
  handleAddNewProduct: (product: ICreateProductPayload) => void
  isDisableFieldAndButton?: boolean
}
const initialFormImages = [null, null, null, null, null]

const ProductAddNewForm = ({ handleAddNewProduct, isDisableFieldAndButton = false }: Props) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values: any) => {
      ...
      handleAddNewProduct(bodyPayload)
    }
  })
